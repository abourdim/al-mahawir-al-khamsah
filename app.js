...
const TRAITS = [
  {
    id:1, emoji:'☝️',
    ar:{title:'الله الواحد',desc:'المحور الأول: الإسلام مبني على التوحيد. يجمع القرآن في حديثه عن الله بين أمرين: فقر العالم إلى الله واستمداد وجوده منه، وأن هذا الخالق الرازق واحد لا شريك له.',verse:'قُلْ هُوَ اللَّهُ أَحَدٌ ۝ اللَّهُ الصَّمَدُ',verseRef:'الإخلاص ١-٢',hadith:'القرآن لا يحتوي مناقشات نظرية — بل يعرّف الناس بربهم عبر التحفيز الفكري وتعميق التأمل',action:'تأمل اليوم في اسم من أسماء الله واشعر بأثره في حياتك',young:'الله واحد! لا شريك له. كل شيء في الكون يحتاج إليه كل لحظة ☝️'},
    en:{title:'God the One',desc:'Axis 1: Islam is built on Tawhid. The Quran combines two things when speaking of God: the world\'s poverty and dependence upon God, and that this Creator-Sustainer is ONE with no partner.',verse:'Say: He is God, the One. God, the Eternal Refuge.',verseRef:'Al-Ikhlas 1-2',hadith:'The Quran contains no abstract theoretical discussions — it acquaints people with their Lord through intellectual stimulation and deepening reflection',action:'Reflect today on one of God\'s Names and feel its effect in your life',young:'God is One! No partner. Everything in the universe needs Him every moment ☝️'},
    fr:{title:'Dieu l\'Unique',desc:'Axe 1 : L\'Islam est bâti sur le Tawhid. Le Coran combine deux choses en parlant de Dieu : la pauvreté du monde envers Dieu, et que ce Créateur-Sustenteur est UN sans associé.',verse:'Dis : Il est Dieu, l\'Unique. Dieu, le Refuge Éternel.',verseRef:'Al-Ikhlas 1-2',hadith:'Le Coran ne contient pas de discussions théoriques abstraites — il fait connaître aux gens leur Seigneur par la stimulation intellectuelle',action:'Méditez sur un des Noms de Dieu et ressentez son effet dans votre vie',young:'Dieu est Un ! Pas d\'associé. Tout dans l\'univers a besoin de Lui à chaque instant ☝️'}
  },
  {
    id:2, emoji:'🚫',
